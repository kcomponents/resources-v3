...
/**
 * Filters services for article module
 *
...
export class ArticleFilterService extends BaseFilterService {
  ...
  public createdByUser: SearchModel = new SearchModel(sc.DATA_TYPES.STRING.native, 'userView.userName');
