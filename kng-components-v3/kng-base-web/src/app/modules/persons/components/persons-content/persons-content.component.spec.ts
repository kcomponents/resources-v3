...
import { PersonsContentComponent } from './persons-content.component';
...
import { PersonsFiltersComponent } from '../persons-filters/persons-filters.component';
...
import { PersonsModalComponent } from '../../modals/persons-modal/persons-modal.component';
import { of } from 'rxjs';

describe('PersonsContentComponent', () => {
  const personsServiceSpy = jasmine.createSpyObj('PersonsService', ['findByFilter', 'deleteData', 'findByFilter']);
  ...
  const personsContentComponent = new PersonsContentComponent(
    messageServiceSpy,
      ...
      'content': [
        {
          ...
          'personId': 'b3968961-47d6-47e8-b89e-5c5bc96e18db',
        ...
        },
        {
          ...
          'personId': 'd1636ea6-b984-4830-8222-db7584ceaf2e',
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(PersonsContentComponent);
  ...
  /* it('should be called method onSearchEvent', () => {
    component.onSearchEvent();
    expect(fixture.nativeElement.querySelector('dataTable')).toBeNull();
  }); */
  ...
  it('should be called method openModal', (done: DoneFn) => {
    dialogServiceSpy.open.and.returnValue({ onClose: of(false) });
    personsContentComponent.openModal();
    expect(dialogServiceSpy.open).toHaveBeenCalled();
    done();
  });

  it('should be called method openModal #If', (done: DoneFn) => {
